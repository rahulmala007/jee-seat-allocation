...
from admission.views import updaterl,showcl,showrl,login,logout,homepage,updateProfile,updateit,security,securitycheck,updatecl,CourseCol,rank_based,rank_based_College_calc,rank_based_Branch_calc,CourseBra,givepref,updatebranches,deletebranches
urlpatterns = [
    # Examples:
    ...
    url(r'^givepref/$',givepref),
    url(r'^updatebranches/$',updatebranches),
    url(r'^deletebranches/$',deletebranches),
